...
const devicesId = "577420972" // 填写在OneNet上获得的devicesId 形式就是一串数字 例子:9939133
const api_key = "xYdbu5AzRlEeb9MRgn=BJjwBzRU=" // 填写在OneNet上的 api-key 例子: VeFI0HZ44Qn5dZO14AuLbWSlSlI=
...
Page({
  ...
  onPullDownRefresh: function () {
    ...
    setTimeout(function () { tanchuang(); }, 2000)
    ...
    return new Promise((resolve, reject) => {
      ...
      wx.request({
        ...
        success: (res) => {
          ...
          that.setData({ chum: res.data.data.datastreams[2].datapoints[0].value })
          that.setData({ ctem: res.data.data.datastreams[0].datapoints[0].value })
          console.log(that.data.chum)
          //tanchuang()
